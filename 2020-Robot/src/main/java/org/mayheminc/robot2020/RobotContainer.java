...
public class RobotContainer {
  ...
  private final Button CLIMB_L3_BUTTON_PAIR = new AndJoystickButton(DRIVER_PAD,
      Constants.GAMEPAD_BUTTION.GAMEPAD_F310_Y_BUTTON, DRIVER_PAD, Constants.GAMEPAD_BUTTION.GAMEPAD_F310_LEFT_BUTTON); // Y=Yellow,
                                                                                                                        // plus
                                                                                                                        // left
                                                                                                                        // top
                                                                                                                        // trigger
  private final Button CLIMB_L2_BUTTON_PAIR = new AndJoystickButton(DRIVER_PAD,
      Constants.GAMEPAD_BUTTION.GAMEPAD_F310_A_BUTTON, DRIVER_PAD, Constants.GAMEPAD_BUTTION.GAMEPAD_F310_LEFT_BUTTON); // A=Green,
                                                                                                                        // plus
                                                                                                                        // left
                                                                                                                        // top
                                                                                                                        // trigger
